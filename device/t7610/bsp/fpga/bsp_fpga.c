...
//=============================================================================
__isr_func_l void _UART_DBG_PORT_ISR(void)
{
...
static int
fpga_stdout_string(char *str, int length)
{
    hal_errno_t     rval = HAL_ERRNO_OK;
...
static int
fpga_stdin_str(char *pBuf, int length)
{
    int         byte_cnt = 0;
    uint32_t    rd_pos = g_uart_io.rd_idx;
    uint32_t    wr_pos = g_uart_io.wr_idx;
...
static hal_errno_t
fpga_set_gpio(bsp_gpio_info_t *pInfo)
{
    hal_errno_t     rval = HAL_ERRNO_OK;
...
//=============================================================================
bsp_desc_t      g_bsp_fpga =
{
    .pf_init           = fpga_init,
    .pf_deinit         = fpga_deinit,
    .pf_stdout_char    = fpga_stdout_char,
    .pf_stdout_string  = fpga_stdout_string,
    .pf_stdin_str      = fpga_stdin_str,
    .pf_set_gpio       = fpga_set_gpio,
    .pf_stdio_flush    = fpga_stdio_flush,
};
