            ...
            while ((*fmt != 0x00) && (!flag_eos))
            {
                switch (*fmt)
                {
                    ...
                    case '.':
                        ...
                        {
                            char *ep;
                            flag_field_precision = strtol(fmt, &ep);
                            fmt = ep;
                        }
                        break;
                    ...
                    case '9':
                        {
                            char *ep;
                            flag_field_width = strtol(fmt, &ep);
                            fmt = ep;
                        }
                        break;
                    ...
                    case 's':
                        {
                            ...
                            long zstr_len = (zstr) ? (long)strlen(zstr) : 0;
                    ...
                    case 'p':
                        {
                            ...
                            _xtoa(arg_zstr, &zstr_len, arg, true);
                    ...
                    case 'X':
                        {
                            ...
                            if (*fmt == 'x')
                                _xtoa(arg_zstr, (unsigned long *)&zstr_len, arg, false);
                            else
                                _xtoa(arg_zstr, (unsigned long *)&zstr_len, arg, true);
                    ...
                    case 'u':
                        {
                            ...
                            if (*fmt == 'u')
                            {
                                ...
                                _ultoa(zstr, (unsigned long *)&zstr_len, arg_u);
                            ...
                            else
                            {
                                ...
                                _ltoa(zstr, (unsigned long *)&zstr_len, (long)arg, false);
                            }
...
int utils_snprintf(char *pbuf, int buf_size, const char *fmt, ...)
{
    ...
    va_start(va, fmt);
    utils_vsprintf(pbuf, buf_size, fmt, va);
...
int utils_puts(char *str)
{
    ...
    if( g_pf_puts )
        rval = g_pf_puts((char*)str, strlen(str)); // STDOUT
